...
public class Program {
	public static void main(String[] args) {
		...
		System.out.println("Thông tin của account1 là : "+account1.email+"\n"+"Tham gia vào group: "+account1.groups[0].name+ " và " + account1.groups[1].name);
...
//		System.out.println("Thông tin của Position1 là: ");
...
//		System.out.println("Position:	" + account1.position.id);
//		System.out.println("LocalDate:	" + account1.createDate);
...
//		System.out.println("Thông tin của Group1 là");
